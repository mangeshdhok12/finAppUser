...
const DmtTransactions = () => {
  ...
  const handleExportExcel = () => {
    console.log('Exporting to Excel with:', { fromDate, toDate });
  };
  
  const handleExportCsv = () => {
    console.log('Exporting to Csv with:', { fromDate, toDate });
  };
  return (
          ...
          <div className="card-header d-flex justify-content-between align-items-center bg-dark">
            <div className="card-title d-flex align-items-center">
              ...
              <div >
                ...
                <small className='text-white'> View DMT Transactions</small>
              </div>
            </div>
                ...
                {isFilterVisible && (
                  <form onSubmit={handleSubmit}>
                    <div className="row">
                      ...
                      <div className="col-lg-3 col-md-3 col-sm-3">
                        <div className="form-group has-feedback">
                          <label htmlFor="toDate">Customer Number</label>
                          <div className="input-group date">
                            <input
                              type="number"
                              className="form-control"
